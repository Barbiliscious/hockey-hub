  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        hero:
          "bg-accent text-accent-foreground hover:bg-accent/90 shadow-glow hover:shadow-glow font-display text-lg tracking-wide",
        success:
        ...
        glass:
          "bg-background/20 backdrop-blur-md border border-border/50 text-foreground hover:bg-background/30",
        gradient:
          "bg-gradient-to-r from-primary via-primary/90 to-secondary text-primary-foreground shadow-lg hover:shadow-xl",
      },
      size: {
